...
def round_robin_scheduling(processes):
    ...
    while ready_queue or remaining_processes:
        if ready_queue:
            ...
            if process.start_time == -1:  # 처음 실행되는 경우 시작 시간 기록
            ...
            gantt_chart.append((process.pid, current_time - execution_time, current_time))
...
if __name__ == "__main__":
    ...
    gantt_chart, finished_processes = round_robin_scheduling(processes)
